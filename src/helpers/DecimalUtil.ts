...
declare module "decimal.js" {
    ...
    namespace Decimal {
        function fromBigNumberish(input: BigNumberish, shiftLeft?: number) : Decimal;
    }
}

Decimal.fromBigNumberish = (input: BigNumberish, shiftLeft: number = 0) => DecimalUtil.fromBigNumberish(input, shiftLeft);
